...
public class DiamondMinerGoalView extends GenericGoalView {

    public DiamondMinerGoalView(Goal model, TextGraphics graphics) {
    ...
    public void draw(int col, int row) {
        ...
        graphics.putString(col, row, "DIAMONDS");
