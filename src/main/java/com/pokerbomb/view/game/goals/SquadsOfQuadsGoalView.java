...
public class SquadsOfQuadsGoalView extends GenericGoalView {
    public SquadsOfQuadsGoalView(Goal model, TextGraphics graphics) {
    ...
    public void draw(int col, int row) {
        ...
        graphics.putString(col, row, "FOUR OF A KIND");
