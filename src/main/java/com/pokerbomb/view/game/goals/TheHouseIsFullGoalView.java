...
public class TheHouseIsFullGoalView extends GenericGoalView {
    public TheHouseIsFullGoalView(Goal model, TextGraphics graphics) {
    ...
    public void draw(int col, int row) {
        ...
        graphics.putString(col, row, "FULL HOUSE");
