...
class TwoPairsHandSpockTest extends Specification {
    def 'Two Pairs com.pockerbomb.model.Hand 1'() {
        given:
    ...
    def 'Two Pairs com.pockerbomb.model.Hand 2'() {
        given:
    ...
    def 'Two Pairs com.pockerbomb.model.Hand 3'() {
        given:
    ...
    def 'Two Pairs com.pockerbomb.model.Hand 4'() {
        given:
        Card card1 = new Card(Suit.DIAMOND, Rank.TWO)
        Card card2 = new Card(Suit.HEART, Rank.TWO)
        Card card3 = new Card(Suit.CLUB, Rank.SIX)
